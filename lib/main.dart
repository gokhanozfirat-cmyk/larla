...
Future<void> _initializeServicesInBackground() async {
  ...
  try {
    await Supabase.initialize(
      ...
      anonKey:
          'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImhxdmxpcHVnbG54amtraWN1d3RiIiwicm9sZSI6ImFub24iLCJpYXQiOjE3Njg4OTgyODcsImV4cCI6MjA4NDQ3NDI4N30.5nmZs2ijC2kIbBx_IisU2N3w18qk-sKSJbZzzCHk4vY',
    );
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      localeResolutionCallback: (locale, supportedLocales) {
        return AppStrings.resolveLocale(locale);
      },
