    ...
    try {
      ...
      return (response as List)
          .map((json) => Prayer(
                ...
                descriptionEng:
                    json['description_eng'] ?? json['description_ing'] ?? '',
  ...
  Future<bool> addPrayer(Prayer prayer) async {
    ...
    try {
      await _client!.from('prayers').insert({
        ...
        'description_eng': prayer.descriptionEng,
        'description_ar': prayer.descriptionAr,
        'description_id': prayer.descriptionId,
        'description_ur': prayer.descriptionUr,
        'description_bn': prayer.descriptionBn,
        'description_fr': prayer.descriptionFr,
        'description_fa': prayer.descriptionFa,
